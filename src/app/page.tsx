...
export default function Home() {
  return (
    ...
    <section className="Hero-sec grid-flow-row overflow-hidden h-full  sm:grid-flow-col md:grid-flow-col lg:pb-40">
        ...
        <App />
        <p className="text-slate-100 pl-52 pt-14 font-semibold w-2/3 sm:text-center md:text-center sm:text-lg md:text-lg sm:w-11/12 sm:-ml-24 md:w-10/12 md:-ml-14 lg:w-8/12 lg:text-left lg:-ml-32 xl:-ml-28 xl:mt-1 xl:w-7/12 xs:text-sm xs:-mt-4 xs:-ml-36 xs:mr-20 xs:text-center xs:w-auto">
    ...
    <section className="about-sec min-h-screen bg-slate-700 mt-80 flex justify-center flex-wrap text-center sm:mt-20 md:mt-20 sm:grid sm:h-auto overflow-hidden lg:pb-28 xs:mt-8 xs:grid" id="about">
      <h1 className="text-white font-semibold h-5 pt-20 sm:text-5xl md:text-6xl sm:pt-10 md:mt-6 md:ml-2 sm:mr-4 md:mr-7 lg:text-6xl lg:mr-14 lg:pt-12 xl:text-7xl xl:ml-14 xs:text-4xl xs:pt-12 xs:-ml-4">About <span className="text-pink-500">Me</span></h1>
      <Image src="/images/Profile.png" width={200} height={200} alt="profile image" id="hero-img" className="shadow-2xl drop-shadow-2xl shadow-black h-56 w-56 rounded-full sm:h-36 sm:w-36 sm:mt-20 sm:ml-56 sm:mr-52 md:ml-72 md:mt-32 md:h-40 md:w-40 lg:h-48 lg:w-48 lg:ml-96 lg:mt-32 xl:ml-auto xl:mr-auto xl:w-52 xl:h-52 xl:mt-36 xs:w-32 xs:h-32 xs:ml-auto xs:mr-auto xs:mt-16"/>
 
      <h2 id="about-text" className="text-pink-600 text-2xl font-semibold mt-auto h-5 sm:text-xl sm:mr-4 sm:mt-6 md:mr-8 lg:text-2xl lg:mt-8 lg:mr-12 xl:-mr-6 xl:text-3xl xl:mt-7 md:text-2xl xs:text-base xs:ml-0 xs:mt-5">Future Full-Stack Developer</h2>

      <p id="about-text" className="text-white text-center text-lg ml-72 mr-72 mt-14 sm:text-sm sm:text-center sm:ml-12 sm:mr-16 sm:mt-7 sm:w-auto md:mr-20 md:mt-8 md:w-auto lg:text-lg lg:ml-14 xl:mt-10 xl:w-9/12 xl:ml-40 md:text-sm xs:text-xs xs:w-64 xs:text-center xs:mt-4">
    ...
    <section className="skills-sec h-screen overflow-hidden bg-slate-700 sm:mt-20 sm:h-auto sm:pb-10 xs:mt-2 md:-mt-3 xs:h-auto xs:pb-20" id="skills">
      <h1 className="text-white flex justify-center text-6xl font-semibold pt-20 sm:text-6xl sm:pt-14 md:mr-10 md:pt-20 lg:text-6xl xl:text-7xl xs:text-4xl">My <span className="text-pink-500 ml-4"> Skills</span></h1>
      
      <div className="flex justify-between mt-14 ml-96 mr-96 -mb-16 sm:mt-20">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-64 md:-ml-72 lg:-ml-64 xl:-ml-32 xl:mt-10 xl:text-lg xs:-ml-80 xs:text-xs">HTML</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-32 sm:text-sm md:-mr-64 lg:-mr-64 xl:-mr-20 xl:mt-10 xl:text-lg xs:text-sm xs:mr-28">90%</span>
      </div>
      
      <div className="w-2/4 bg-gray-200 rounded-full h-2.5 ml-auto mr-auto mt-20 md:ml-20 lg:ml-32 xl:ml-64 xs:w-64 sm:w-96 md:w-9/12 xl:w-7/12">
      <div className="bg-pink-500 h-2.5 rounded-full w-11/12 "></div>
      </div>

      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-64 md:-ml-72 lg:-ml-64 xl:-ml-32 xl:text-lg xs:-ml-80 xs:text-sm">CSS</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-32 sm:text-sm md:-mr-64 lg:-mr-64 xl:-mr-20 xl:text-lg xs:text-sm xs:mr-28">87%</span>
      </div>
      ...
      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-64 md:-ml-72 lg:-ml-64 xl:-ml-32 xl:text-lg xs:-ml-80 xs:text-sm">TypeScript</span>
          <span className="text-lg font-sans font-normal text-white mr-20 sm:-mr-32 sm:text-sm md:-mr-64 lg:-mr-64 xl:-mr-20 xl:text-lg xs:text-sm xs:mr-28">75%</span>
      </div>
      ...
      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-64 md:-ml-72 lg:-ml-64 xl:-ml-32 xl:text-lg xs:-ml-80 xs:text-sm">Next.js</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-32 sm:text-sm md:-mr-64 lg:-mr-64 xl:-mr-20 xl:text-lg xs:text-sm xs:mr-28">92%</span>
      </div>
      ...
      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16 ">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-64 md:-ml-72 lg:-ml-64 xl:-ml-32 xl:text-lg xs:-ml-80 xs:text-sm">Tailwind CSS</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-32 sm:text-sm md:-mr-64 lg:-mr-64 xl:-mr-20 xl:text-lg xs:text-sm xs:mr-28">80%</span>
      </div>
      
      <div className="w-2/4 bg-gray-200 rounded-full h-2.5 ml-auto mr-auto mt-20 sm:mb-20 md:ml-20 lg:ml-32 xl:ml-64 xs:w-64 sm:w-96 md:w-9/12 xl:w-7/12">
    ...
    <section className="Contact-sec h-screen overflow-hidden sm:h-auto sm:-mb-80 xs:h-auto" id="contact">
      <h3 className="text-white font-semibold text-6xl ml-40 pt-48 sm:text-5xl sm:mr-7 sm:pt-24 md:text-6xl  lg:text-6xl lg:pt-24 lg:ml-20 lg:text-left xl:pt-32 xl:ml-28 xs:text-4xl xs:-ml-0 xs:text-center xs:pt-20">Get in <span className="text-pink-500">Touch</span></h3>
      <p className="text-white text-lg ml-40 mt-10 w-4/12 sm:text-lg sm:text-center sm:ml-36 sm:w-80  md:text-lg md:ml-52 md:mt-10 md:w-80 lg:ml-20 lg:mt-8 lg:text-left xl:ml-28 xl:w-96 xs:text-sm xs:ml-10 xs:text-center xs:w-60 xs:mt-6">
      ...
      <div className="flex justify-center ml-48 mt-20 space-x-8 sm:mt-10 sm:mr-8 lg:justify-start lg:ml-20 xl:ml-28 xl:mt-14 xs:ml-0 xs:mt-10 xs:space-x-4">
      ...
      <form className="w-4/12 flex mr-72 -mt-80 xs:ml-4 sm:mt-20 sm:ml-24 md:ml-36 lg:ml-auto lg:-mt-80 xl:pt-6 xs:mt-8 ">
