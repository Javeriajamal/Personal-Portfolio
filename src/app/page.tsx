...
export default function Home() {
  return (
    ...
    <section className="Hero-sec grid-flow-row overflow-hidden h-full xs:pb-14  sm:grid-flow-col md:grid-flow-col lg:pb-40">
        <h1 className="text-white font-semibold text-6xl px-52 pt-48 sm:text-4xl sm:w-8/12 md:text-5xl lg:text-5xl sm:space-x-10 sm:px-14 sm:text-center sm:ml-24 md:text-center md:ml-28 md:w-8/12 lg:-ml-20 lg:w-9/12 lg:pt-60 xl:-ml-28 xl:text-6xl sm:space-y-10 xs:text-4xl xs:-mt-16 xs:text-center xs:-ml-[128px] xs:px-28 lg:space-x-3"><span className="xs:ml-28 sm:ml-16">Hi, I am </span><span className="text-pink-500 font-serif sm:w-auto xs:w-full xs:-mr-28 md:w-auto md:flex-nowrap ">Javeria Jamal</ span></h1>
        <App />
        <p className="text-slate-100 pl-52 pt-14 font-semibold w-2/3 sm:text-center md:text-center sm:text-lg md:text-lg sm:w-11/12 sm:-ml-24 md:w-10/12 md:-ml-14 lg:w-8/12 lg:text-left lg:-ml-32 xl:-ml-28 xl:mt-1 xl:w-7/12 xs:text-sm xs:-mt-8 xs:-ml-[164px] xs:mr-20 xs:text-center xs:w-[500px] ">
    ...
    <section className="about-sec min-h-screen bg-slate-700 mt-80 flex justify-center flex-wrap text-center xs:h-full sm:mt-20 md:mt-20 sm:grid sm:h-auto overflow-hidden lg:pb-28 xs:mt-2 xs:grid" id="about">
      ...
      <h2 id="about-text" className="text-pink-600 text-2xl font-semibold mt-auto h-5 sm:text-xl sm:mr-4 sm:mt-6 md:mr-8 lg:text-2xl lg:mt-8 lg:mr-12 xl:-mr-6 xl:text-3xl xl:mt-7 md:text-2xl xs:text-lg xs:-ml-1 xs:mt-2">Future Full-Stack Developer</h2>

      <p id="about-text" className="text-white text-center text-lg ml-72 mr-72 mt-14 sm:text-sm sm:text-center sm:ml-12 sm:mr-16 sm:mt-7 sm:w-auto md:mr-20 md:mt-8 md:w-auto lg:text-lg lg:ml-14 xl:mt-10 xl:w-9/12 xl:ml-40 md:text-sm xs:text-xs xs:w-80 xs:ml-[245px] xs:mr-[255px] xs:text-center xs:mt-3">
    ...
    <section className="skills-sec h-screen overflow-hidden bg-slate-700 sm:mt-20 sm:h-auto sm:pb-10 xs:mt-2 md:-mt-3 xs:h-auto xs:pb-20" id="skills">
      ...
      <div className="flex justify-between mt-14 ml-96 mr-96 -mb-16 sm:mt-20">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-64 md:-ml-72 lg:-ml-64 xl:-ml-32 xl:mt-10 xl:text-lg xs:-ml-[348px] xs:text-xs">HTML</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-32 sm:text-sm md:-mr-64 lg:-mr-64 xl:-mr-20 xl:mt-10 xl:text-lg xs:text-sm xs:mr-7">90%</span>
      </div>
      
      <div className="w-2/4 bg-gray-200 rounded-full h-2.5 ml-auto mr-auto mt-20 md:ml-20 lg:ml-32 xl:ml-64 xs:w-80 xs:mx-9 sm:w-96 md:w-9/12 xl:w-7/12 ">
      <div className="bg-pink-500 h-2.5 rounded-full w-11/12 "></div>
      </div>

      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-64 md:-ml-72 lg:-ml-64 xl:-ml-32 xl:text-lg xs:-ml-[344px] xs:text-sm">CSS</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-32 sm:text-sm md:-mr-64 lg:-mr-64 xl:-mr-20 xl:text-lg xs:text-sm xs:mr-7">87%</span>
      </div>
      
      <div className="w-2/4 bg-gray-200 rounded-full h-2.5 ml-auto mr-auto mt-20 md:ml-20 lg:ml-32 xl:ml-64 xs:w-80 xs:mx-10 sm:w-96 md:w-9/12 xl:w-7/12">
      <div className="bg-pink-500 h-2.5 rounded-full w-10/12"></div>
      </div>

      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-64 md:-ml-72 lg:-ml-64 xl:-ml-32 xl:text-lg xs:-ml-[344px] xs:text-sm">TypeScript</span>
          <span className="text-lg font-sans font-normal text-white mr-20 sm:-mr-32 sm:text-sm md:-mr-64 lg:-mr-64 xl:-mr-20 xl:text-lg xs:text-sm xs:mr-7">75%</span>
      </div>
      ...
      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-64 md:-ml-72 lg:-ml-64 xl:-ml-32 xl:text-lg xs:-ml-[344px] xs:text-sm">Next.js</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-32 sm:text-sm md:-mr-64 lg:-mr-64 xl:-mr-20 xl:text-lg xs:text-sm xs:mr-7">92%</span>
      </div>
      ...
      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16 ">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-64 md:-ml-72 lg:-ml-64 xl:-ml-32 xl:text-lg xs:-ml-[344px] xs:text-sm">Tailwind CSS</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-32 sm:text-sm md:-mr-64 lg:-mr-64 xl:-mr-20 xl:text-lg xs:text-sm xs:mr-7">80%</span>
      </div>
      
      <div className="w-2/4 bg-gray-200 rounded-full h-2.5 ml-auto mr-auto mt-20 sm:mb-20 md:ml-20 lg:ml-32 xl:ml-64 xs:mx-10 xs:w-80 sm:w-96 md:w-9/12 xl:w-7/12">
    ...
    <section className="Contact-sec h-screen overflow-hidden sm:h-auto sm:-mb-80 xs:h-auto" id="contact">
      ...
      <form className="w-4/12 flex mr-72 -mt-80 xs:ml-14 sm:mt-20 sm:ml-24 md:ml-36 lg:ml-auto lg:-mt-80 xl:pt-6 xs:mt-8  ">
        <fieldset className="rounded-md px-20 py-10 md:px-7 lg:px-4 lg:ml-40 xs:pl-2 flex-col justify-center">
