...
export default function Home() {
  return (
    ...
    <section className="Hero-sec grid-flow-row overflow-hidden h-full sm:grid-flow-col  md:grid-flow-col lg:pb-40">
        <h1 className="text-white font-semibold text-6xl px-52 pt-48 sm:text-3xl md:text-5xl lg:text-5xl sm:space-x-10 sm:text-center  md:text-center md:-ml-2 md:w-screen lg:text-start lg:-ml-32 xl:mr-10 xl:text-5xl sm:space-y-10 ">Hi, I am <span className="text-pink-500 font-serif sm:w-auto"> Javeria Jamal</span></h1>
        <App />
        <p className="text-slate-100 pl-52 pt-14 font-semibold w-2/3 sm:text-center md:text-center sm:text-lg md:text-lg  sm:w-11/12 sm:-ml-20 md:w-9/12 md:-ml-6 lg:w-3/5 lg:text-left lg:-ml-32 xl:mr-10 xl:w-4/6">
        ...
        <span className="relative sm:text-base xl:text-lg">Hire Me</span>
        </Link>

      <Image src="/images/heroimage.png" width={200} height={200} alt="profile image" className=" shadow-2xl drop-shadow-2xl shadow-pink-500 flex justify-self-end mr-96 rounded-full -mt-80 sm:hidden md:hidden lg:block lg:-mt-96 lg:mr-28 lg:h-64 lg:w-64 xl:mr-44 2xl:mr-96 xl:h-72 xl:w-72" />
    ...
    <section className="about-sec min-h-screen bg-slate-700 mt-80 flex justify-center flex-wrap text-center sm:mt-20 md:mt-20 sm:grid sm:h-auto overflow-hidden lg:pb-28" id="about">
      <h1 className="text-white font-semibold text-6xl h-5 pt-20 sm:text-4xl md:text-5xl sm:pt-8 md:mt-6 sm:mr-8 md:mr-8 lg:text-6xl lg:pt-12 xl:text-6xl xl:ml-16">About <span className="text-pink-500">Me</span></h1>
      <Image src="/images/profileimage.jpg" width={200} height={200} alt="profile image" id="hero-img" className="shadow-2xl drop-shadow-2xl shadow-black h-56 w-56 rounded-full mt-48 -ml-64 sm:h-32 sm:w-32 sm:mt-16 sm:ml-60 md:ml-72 md:mt-20 md:h-36 md:w-36 lg:h-48 lg:w-48 lg:ml-96 lg:mt-28 xl:ml-auto xl:mr-auto "/>
 
      <h2 id="about-text" className="text-pink-600 text-2xl font-semibold mt-auto -mb-5 -ml-64 h-5 sm:text-lg sm:-mr-60 sm:mt-6 md:-mr-56 lg:text-2xl lg:mt-8 xl:-mr-64 xl:text-2xl xl:mt-7 md:text-xl">Future Full-Stack Developer</h2>

      <p id="about-text" className="text-white text-center text-lg ml-72 mr-72 mt-14 sm:text-xs sm:text-center sm:ml-24 sm:mr-24 sm:mt-10 md:mr-32 lg:text-lg xl:mt-14 md:text-sm">
      ...
      <Link href="https://www.linkedin.com/in/javeria-jamal-23a9552b3" target="_blank" className="relative inline-flex items-center mt-2 justify-center px-10 h-16 w-52 overflow-hidden font-bold text-white border-2 border-white rounded-md shadow-2xl group sm:mt-10 sm:ml-64 sm:w-32 sm:h-12 sm:px-5 sm:mb-10 md:ml-72 lg:ml-96 lg:w-40 lg:h-14 xl:ml-auto xl:mr-auto ">
    ...
    <span className="relative sm:text-sm lg:text-sm xl:text-sm">Read More</span>
    ...
    <section className="skills-sec h-screen overflow-hidden bg-slate-700 mt-96 sm:mt-20 sm:h-auto sm:pb-10" id="skills">
      ...
      <div className="flex justify-between mt-14 ml-96 mr-96 -mb-16 sm:mt-20">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-56 lg:-ml-40 xl:-ml-20">HTML</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-24 sm:text-sm md:-mr-40 lg:-mr-24 xl:-mr-0">90%</span>
      </div>
      
      <div className="w-2/4 bg-gray-200 rounded-full h-2.5 ml-auto mr-auto mt-20 md:ml-40 lg:ml-56 xl:ml-72 ">
      <div className="bg-pink-500 h-2.5 rounded-full w-11/12 " ></div>
      </div>

      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-56 lg:-ml-40 xl:-ml-20">CSS</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-24 sm:text-sm md:-mr-40 lg:-mr-24 xl:-mr-0">87%</span>
      </div>
      ...
      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-56 lg:-ml-40 xl:-ml-20">TypeScript</span>
          <span className="text-lg font-sans font-normal text-white mr-20 sm:-mr-24 sm:text-sm md:-mr-40 lg:-mr-24 xl:-mr-0">75%</span>
      </div>
      ...
      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-56 lg:-ml-40 xl:-ml-20">Next.js</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-24 sm:text-sm md:-mr-40 lg:-mr-24 xl:-mr-0">92%</span>
      </div>
      ...
      <div className="flex justify-between mt-20 ml-96 mr-96 -mb-16 ">
          <span className="text-lg font-normal font-sans text-white ml-16 sm:text-base sm:-ml-56 lg:-ml-40 xl:-ml-20">Tailwind CSS</span>
          <span className="font-sans font-normal text-white mr-20 sm:-mr-24 sm:text-sm md:-mr-40 lg:-mr-24 xl:-mr-0">80%</span>
      </div>
      
      <div className="w-2/4 bg-gray-200 rounded-full h-2.5 ml-auto mr-auto mt-20 sm:mb-20 md:ml-40 lg:ml-56 xl:ml-72">
    ...
    <section className="Contact-sec h-screen overflow-hidden sm:h-auto sm:-mb-80" id="contact">
      ...
      <form className="w-4/12 flex justify-self-end mr-72 -mt-80 sm:mt-20 sm:mr-96 lg:mr-40 lg:-mt-80">
        <fieldset className="rounded-md px-20 py-10 md:px-7 lg:px-4 ">
            <input type="text" id="name" autoComplete="additional-name" placeholder="Full name" required className=" placeholder-white px-4 py-3 w-full bg-black-100 border-2 mt-4 text-white border-pink-500 rounded-md"></input>

            <input type="email" id="email" autoComplete="billing email" placeholder="Email" required className="px-4 py-3 placeholder-white w-full bg-black-100 border-2 mt-7 text-white border-pink-500 rounded-md"></input>
            ...
            <span className="relative w-full text-left text-white transition-colors duration-200 ease-in-out group-hover:text-black-100 xl:text-sm">Send message</span>
            </Link>
