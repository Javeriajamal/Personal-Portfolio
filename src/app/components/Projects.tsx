...
export const Projects = () => {
  return (
    ...
    <section id='projects' className='h-screen pt-4 sm:h-auto overflow-hidden xl:pb-10 xs:h-auto'>
      <h1 className='text-white text-6xl font-semibold flex justify-center pt-20 sm:text-5xl sm:-mt-7 md:text-6xl md:mr-7 md:mt-4 lg:text-6xl lg:mr-12 lg:mt-2 xl:text-7xl xl:mr-10 xs:text-4xl xs:-mt-10 '>My <span className='text-pink-500 ml-3'> Projects</span></h1>
    
        <div className='boxes grid grid-cols-3 gap-20 mt-20 sm:grid sm:grid-cols-2 sm:ml-5 sm:gap-8 lg:grid-cols-3 lg:ml-4 lg:mr-4 md:grid-cols-2 md:mt-20 xl:ml-16 xl:mr-20 xl:gap-14 xs:grid-cols-1 xs:ml-5 xs:gap-10 xs:mt-14 xs:mb-20'>
