...
export const Header = () => {
  return (
    ...
    <div className='header fixed z-10 flex justify-between px-28 py-6 h-32 w-full bg-slate-500 overflow-hidden lg:overflow-visible sm:h-20 sm:w-full md:h-20 lg:h-20 xl:h-20 '>
